...
namespace OneSchool.Core.ViewModels
{
    ...
    public partial class vmBlock_SiteNav 
    {
        ...
        [Newtonsoft.Json.JsonProperty("navButtons", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.List<vmBlock_DataLink> NavButtons { get; set; }
